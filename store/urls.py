...
urlpatterns = [
    ...
    path('dashboard/products/import/', views.admin_product_import, name='admin_product_import'),
    ...
    path('dashboard/products/bulk-update/', views.admin_product_bulk_update, name='admin_product_bulk_update'),
